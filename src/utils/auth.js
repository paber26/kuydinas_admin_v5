...
const rawApiBaseUrl = trimTrailingSlash(
  import.meta.env.VITE_API_BASE_URL || import.meta.env.VITE_ADMIN_API_BASE_URL || ""
)

export const BACKEND_ORIGIN = resolveOrigin(rawApiBaseUrl)

export const ADMIN_API_BASE_URL = rawApiBaseUrl.endsWith("/admin") ? rawApiBaseUrl : `${BACKEND_ORIGIN}/api/admin`
