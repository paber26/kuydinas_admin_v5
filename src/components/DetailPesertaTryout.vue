          ...
          <template v-else-if="selectedUserDetail">
            ...
            <div class="space-y-2 text-sm text-slate-600">
              <div class="flex items-center gap-2">
                ...
                <a
                  v-if="selectedUserDetail.user.whatsapp"
                ...
                >
                  <svg class="h-3 w-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="currentColor"><path d="M380.9 97.1C339 55.1 283.2 32 223.9 32c-122.4 0-222 99.6-222 222 0 39.1 10.2 77.3 29.6 111L0 480l117.7-30.9c32.4 17.7 68.9 27 106.1 27h.1c122.3 0 224.1-99.6 224.1-222 0-59.3-25.2-115-67.1-157zM223.9 414.7h-.1c-32.5 0-64.3-8.7-92.3-25.3l-6.6-3.9-68.6 18 18.3-66.9-4.3-6.9c-18.1-28.9-27.7-62.8-27.7-97.6 0-101.4 82.5-184 184-184 49.2 0 95.4 19.3 130.3 54.1 34.8 34.9 54 81.3 54 130.4 0 101.5-82.6 184-184.2 184zm101.2-138.2c-5.5-2.8-32.8-16.2-37.9-18-5.1-1.9-8.8-2.8-12.5 2.8-3.7 5.6-14.3 18-17.6 21.8-3.2 3.7-6.5 4.2-12 1.4-32.6-16.3-54-29.1-75.5-66-5.7-9.8 5.7-9.1 16.3-30.3 1.8-3.7 .9-6.9-.5-9.7-1.4-2.8-12.5-30.1-17.1-41.2-4.5-10.8-9.1-9.3-12.5-9.5-3.2-.2-6.9-.2-10.6-.2-3.7 0-9.7 1.4-14.8 6.9-5.1 5.6-19.4 19-19.4 46.3 0 27.3 19.9 53.7 22.6 57.4 2.8 3.7 39.1 59.7 94.8 83.8 35.2 15.2 49 16.5 66.6 13.9 10.7-1.6 32.8-13.4 37.4-26.4 4.6-13 4.6-24.1 3.2-26.4-1.3-2.5-5-3.9-10.5-6.6z"/></svg>
                  Chat WhatsApp
                </a>
              </div>
